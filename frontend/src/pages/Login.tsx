...
function ParticleCanvas() {
  ...
  useEffect(() => {
    ...
    /* Healthcare icon paths — simple SVG-like shapes drawn on canvas */
    const ICONS = [
      // cross / plus
      ...
      // stethoscope (simplified circle + line)
      (cx: number, cy: number, r: number, c: CanvasRenderingContext2D) => {
        c.beginPath();
    ...
    const draw = () => {
      ...
      /* Deep space background — NOT a gradient hero, this is the scene */
      ...
      /* Central glow orb — warm amber/orange like the reference image */
      ...
      /* Draw connections — dashed lines like the reference */
      ctx.save();
      ...
      nodes.forEach(n => {
        ...
        const scale = 0.5 + n.z * 0.7;  // depth / perspective
        ...
        /* Circle ring — dashed like reference */
        ctx.save();
        ctx.setLineDash([4, 3]);
...
export default function Login() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      navigate(u?.role === 'admin' ? '/admin/dashboard' : '/worker/dashboard', { replace: true });
    } catch (err) {
      setApiError(
          ...
          >
            ...
            <div className="px-9 pt-9 pb-10">
              ...
              <div className="flex items-center gap-2.5 mb-8">
                ...
                <div>
                  <p className="font-display text-sm font-bold text-white tracking-tight leading-none">HDOP</p>
                  <p className="text-[9px] font-mono text-blue-400/60 tracking-widest uppercase leading-none mt-0.5">Healthcare Data Ops</p>
                </div>

                {/* Live ping — top right of card */}
              ...
              <form onSubmit={handleSubmit} noValidate aria-label="Login form">
                ...
                <div className="mb-4">
                  ...
                  <input
                    ...
                    onFocus={e => { e.currentTarget.style.border = '1px solid rgba(96,165,250,0.5)'; e.currentTarget.style.boxShadow = '0 0 0 3px rgba(59,130,246,0.1), inset 0 1px 2px rgba(0,0,0,0.3)'; }}
                    onBlur={e => {
                      setTouched(t => ({ ...t, email: true }));
                      e.currentTarget.style.boxShadow = 'inset 0 1px 2px rgba(0,0,0,0.3)';
                      e.currentTarget.style.border = touched.email && errs.email ? '1px solid rgba(239,68,68,0.5)' : '1px solid rgba(96,165,250,0.15)';
                    }}
                  />
                ...
                <div className="mb-7">
                  <div className="flex justify-between mb-2">
                    <label htmlFor="password"
                           className="text-[10px] font-mono tracking-[0.15em] text-blue-300/50 uppercase">
                      Password
                    </label>
                  ...
                  <input
                    ...
                    onBlur={e => {
                      ...
                      e.currentTarget.style.boxShadow = 'inset 0 1px 2px rgba(0,0,0,0.3)';
                      e.currentTarget.style.border = touched.password && errs.password ? '1px solid rgba(239,68,68,0.5)' : '1px solid rgba(96,165,250,0.15)';
                    }}
                  />
